  ...
  private void Subdivide()
    {
     ...
     TEdge E7=new TEdge(_Edge1.Edge1().BottomEnd(),
                        _Edge2.Edge1().BottomEnd(),E1.Seed(),E1.SD()) ;
     TEdge E8=new TEdge(_Edge1.Edge1().BottomEnd(),
                        _Edge3.Edge1().BottomEnd(),E1.Seed(),E1.SD()) ;  
     TEdge E9=new TEdge(_Edge2.Edge1().BottomEnd(),
                        _Edge3.Edge1().BottomEnd(),E1.Seed(),E1.SD()) ;
